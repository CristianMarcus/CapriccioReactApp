...
// Componente de "Skeleton Loader" para detalles (sin cambios, solo se incluye para contexto)
...
// ProductDetailPage ya no necesita onAddToCart como prop
const ProductDetailPage = () => {
  ...
  const { handleAddToCart } = useCarrito(); // Obtenemos handleAddToCart del contexto
